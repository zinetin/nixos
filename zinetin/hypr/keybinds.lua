...
-- Vim bind anywhere 
hl.bind("SUPER + h",                   hl.dsp.send_shortcut({ mods = "", key = "left", window = "activewindow" }))
hl.bind("SUPER + j",                   hl.dsp.send_shortcut({ mods = "", key = "down", window = "activewindow" }))
hl.bind("SUPER + k",                   hl.dsp.send_shortcut({ mods = "", key = "up", window = "activewindow" }))
hl.bind("SUPER + l",                   hl.dsp.send_shortcut({ mods = "", key = "right", window = "activewindow" }))
hl.bind("SUPER + x",                   hl.dsp.send_shortcut({ mods = "", key = "backspace", window = "activewindow" }))
